# RailsAdmin config file. Generated on January 05, 2014 17:58
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Sell Content', 'Admin']
  ...
  # config.excluded_models = ['Asset', 'Content', 'Image', 'Order', 'Product', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Asset', 'Content', 'Image', 'Order', 'Product', 'User']
  ...
  #     configure :attachment_file_size, :integer 
  #     configure :attachment_updated_at, :datetime 
  #     configure :type, :string 
  #     configure :for_sale, :boolean 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :sold_orders, :has_many_association 
  #     configure :bought_orders, :has_many_association 
